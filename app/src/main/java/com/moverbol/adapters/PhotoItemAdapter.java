...
import com.moverbol.model.photoes.ImageItemModel;
...
public class PhotoItemAdapter extends RecyclerView.Adapter<PhotoItemAdapter.ViewHolder> {
    private List<ImageItemModel> imagesModelList;
    ...
    @Override
    public void onBindViewHolder(final PhotoItemAdapter.ViewHolder viewHolder, final int i) {
        viewHolder.photoItemBinding.txtName.setText(imagesModelList.get(i).getItemName());
    ...
    public void setPhotoModelList(List<ImageItemModel> photoUrlList) {
