 ...
 */
public class CustomSpinnerBolAdapter <T> extends BaseAdapter {
    private List<T> dataList = new ArrayList<>();
    private Context context;
    private int resourceLayoutId;

    public CustomSpinnerBolAdapter(Context context, int resourceLayoutId, @NonNull List<T> dataList) {
        this.dataList = dataList;
        this.context = context;
        this.resourceLayoutId = resourceLayoutId;
    }

    public CustomSpinnerBolAdapter(Context context, int resourceLayoutId, @NonNull T[] dataArray) {
