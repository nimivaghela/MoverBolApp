...
import com.moverbol.databinding.CratingChargesBOLItemBinding;
import com.moverbol.model.billOfLading.newRequestChargesMoleds.CommonChargesRequestModel;

import java.util.ArrayList;
import java.util.List;

public class CratingChargeBolAdapter extends RecyclerView.Adapter<CratingChargeBolAdapter.HomeItemHolder> {
    ...
    public CratingChargeBolAdapter(){
        this.chargesList = new ArrayList<>();
    }

    @Override
    public HomeItemHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_crating_charges_bol_item, parent, false);
    ...
    public class HomeItemHolder extends RecyclerView.ViewHolder {
        CratingChargesBOLItemBinding binding;
