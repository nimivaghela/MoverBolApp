...
import com.moverbol.databinding.ValuationChargesItemBOLBinding;
 ...
 */
public class ValuationChargesBolAdapter extends RecyclerView.Adapter<ValuationChargesBolAdapter.HomeItemHolder>  {
    ...
    public ValuationChargesBolAdapter() {
        this.chargesList = new ArrayList<>();
    }

    @Override
    public ValuationChargesBolAdapter.HomeItemHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_valuation_charges_bol_item, parent, false);
        return new ValuationChargesBolAdapter.HomeItemHolder(view);
    }


    @Override
    public void onBindViewHolder(ValuationChargesBolAdapter.HomeItemHolder holder, int position) {
    ...
    public class HomeItemHolder extends RecyclerView.ViewHolder {
        ValuationChargesItemBOLBinding binding;
