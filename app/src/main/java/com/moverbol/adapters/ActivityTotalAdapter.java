...
public class ActivityTotalAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ActivityTotalAdapter(boolean isBillingSummary, String activityFlag) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof ViewHolderItem) {
            ...
            viewHolderItem.binding.setIsShowTotal(true);
            ...
            viewHolderHeader.bindingHeader.setIsShowTotal(true);
  ...
  /*  public void showTotal(boolean isShowTotal) {
    ...
    public int getItemViewType(int position) {
        if (position == 0) {
            return TYPE_HEADER;
        } else if (position == homeList.size() && showCharges == 1) {
            return TYPE_FOOTER;
        }
        return TYPE_ITEMS;
    }
